...
<head runat="server">
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        /* Put your background photo at ~/image/login-bg.jpg (or change the path below) */
        ...
        .social-row a:hover { background: rgba(255,255,255,0.3); }
        ...
        .btn-signin:hover { background: #CC5222; }
        ...
        .lost-password:hover { opacity: 0.85; }

        @media (max-width: 900px) {
            .login-content { flex-direction: column; align-items: flex-start; padding: 40px 24px; }
            .welcome-side, .signin-side { max-width: 100%; }
        }
    </style>
</head>
<body>
